  ...
  <div class="admin-shell" :class="{ 'is-open': sidebarOpen }">
    ...
    <div class="admin-main">
      <header class="topbar">
        ...
        <LanguageSwitcher />
        <router-link to="/" class="topbar__btn">{{
          $t("common.backToSite")
        }}</router-link>
        <button class="topbar__btn topbar__btn--out" @click="logout">
          {{ $t("common.logout") }}
        </button>
      </header>
...
const ICONS = {
  ...
  tag: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12.6 2.3a1 1 0 0 0-.7-.3H4a2 2 0 0 0-2 2v7.9a1 1 0 0 0 .3.7l8.4 8.4a2 2 0 0 0 2.8 0l7.1-7.1a2 2 0 0 0 0-2.8z"/><circle cx="7.5" cy="7.5" r="1.5" fill="currentColor"/></svg>',
  ...
  data() {
    return {
      ...
      links: [
        ...
        { to: "/admin/categories", label: "Catégories", icon: ICONS.tag },
        ...
        { to: "/admin/staff", label: "Personnels", icon: ICONS.staff },
