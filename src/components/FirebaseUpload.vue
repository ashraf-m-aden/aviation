    ...
    <div class="row">
      <div class="col-12">
        <div class="d-flex flex-column">
          {{ message }}:
          <input v-show="!isBanner && !isNews" class="input" type="text" placeholder="Nom du document"
          ...
          <input type="file" v-show="!isBanner && !isNews" id="inputContent" @change="previewImage"
            accept=".json,.pdf,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" />
          <input type="file" v-show="isBanner || isNews" id="inputContent" @change="previewImage" accept="image/*" />
        </div>
        <div class="col-12" v-if="imageData != null">
          ...
          <button v-if="!loading && !errorButton" class="btn small btn-group btn-outline-success" @click="onUpload">
            Charger
          </button>
          <button v-if="loading && !errorButton" class="btn disabled small btn-group btn-outline-success">
        ...
        <div class="col-12" v-if="documentData != null">
          <img class="preview" :src="picture" />
          <br />
          <button v-if="!loading && document.name" @click="onUpload" class="btn small btn-group btn-outline-success">
            Charger
          </button>
          <button v-if="loading" class="btn disabled small btn-group btn-outline-success">
